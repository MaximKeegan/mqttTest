...
//    var appState : UIApplicationState
    ...
    func subscribeToChannel() {
        ...
        MQTTClient.shared.mqtt?.subscribe("/heater/1/relay/1/status", qos: CocoaMQTTQOS.qos1)
        MQTTClient.shared.mqtt?.subscribe("/heater/1/relay/2/status", qos: CocoaMQTTQOS.qos1)
        MQTTClient.shared.mqtt?.subscribe("/heater/1/relay/3/status", qos: CocoaMQTTQOS.qos1)
        MQTTClient.shared.mqtt?.subscribe("/heater/1/setpoint/status", qos: CocoaMQTTQOS.qos1)
        MQTTClient.shared.mqtt?.subscribe("/heater/1/rules/status", qos: CocoaMQTTQOS.qos1)
    }
